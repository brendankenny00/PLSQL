...
create table 	Landlord	 (												
	Landlord_Id	 Number	(	3	)	,								
	 Fname	 Varchar2	(	8	)	 Constraint Landlord_Fname_NN Not Null,								
	 Sname	 Varchar2	(	9	)	 Constraint Landlord_Sname_NN Not Null,								
	 Address	 Varchar2	(	9	)	,								
	 County	 Varchar2	(	10	)	,								
	 Gender	 Varchar2	(	6	)	,								
	 Birth_Date	  Date  				,								
	 ...
	 Constraint 	 Landlord_Specialism_Ck				 Check(Specialism in('Dairy','Sheep','Tillage','Beef')),								
	 Constraint 	 Landlord_Category_Ck				 Check(Category in('Retired Farmer','Current Farmer','Non Farmer')),								
	 Constraint 	 Landlord_Email_Uq				 Unique(Email),								
	 Constraint 	 Landlord_Mobile_No_Uq				 Unique(Mobile_No),								
	 Constraint 	 Landlord_Gender_Ck				 Check(Gender in('Male','Female')),								
	 Constraint 	 Landlord_County_Ck				 Check(Specialism in('Dairy','Sheep','Tillage','Beef')));								
...
create table 	Farm 	(												
	...
	Size_	 Number 	(	3	)	,								
	 ...
	 Constraint 	 Farm_Farm_Id_Pk				 Primary Key(Farm_Id),								
	 Constraint 	 Farm_Landlord_Id_Fk				 Foreign Key(Landlord_Id) References Landlord(Landlord_Id),								
	 Constraint 	 Farm_Size_Ck				 Check(Size_ between 80 and 300),								
	 Constraint 	 Farm_Terrain_Ck				 Check(Terrain in('Flat','Hilly')),								
	 Constraint 	 Farm_Drainage_Ck				 Check(Drainage in('Boggy','Wet','Dry')),								
	 Constraint 	 Farm_Usage_Ck				 Check(Usage in ('Grazing','Tillage')),								
	 Constraint 	 Farm_Estimated_Value_Ck				 Check(Estimated_Value between 80000 and 250000));								
...
create table 	Farmer 	(												
	Farmer_Id	 Number	(	4	)	,								
	 Fname	 Varchar2 	(	10	)	 Constraint Farmer_Fname_NN Not Null,								
	 Sname	 Varchar2 	(	8	)	 Constraint Farmer_Sname_NN Not Null,								
	 Address	 Varchar2 	(	15	)	,								
	 County	 Varchar2 	(	8	)	,								
	 Gender	 Varchar2 	(	6	)	,								
	 Date_Of_Birth	 Date 				,								
	...
	Constraint	 Farmer_Farmer_Id_Pk				 Primary Key(Farmer_Id),								
	Constraint	 Farmer_County_Ck				 Check(County in('Dublin','Galway','Louth','Cork','Sligo','Monaghan','Offaly')),								
	Constraint	 Farmer_Gender_Ck				 Check(Gender in('Male','Female')),								
	Constraint	 Farmer_Mobile_No_Uq				Unique(Mobile_No),								
	Constraint	 Farmer_Email_Address_Uq				Unique(Email_Address),								
	Constraint	 Farmer_Qualifications_Ck				Check(Qualifications in ('Farming Cert','B.Agr')),								
	Constraint	Farmer_Specialism_Ck				Check(Specialism in ('Beef','Tillage','Sheep')),								
	Constraint	Farmer_Annual_Sales_Ck				Check(Annual_Sales between 11000 and 25000));								
...
create table 	Solicitor 	(												
	Solicitor_Id	 Number	(	4	)	,								
	 Fname	 Varchar2 	(	10	)	Constraint Solicitor_Fname_NN Not Null,								
	 Sname	 Varchar2 	(	9	)	Constraint Solicitor_Sname_NN Not Null,								
	 Address	 Varchar2 	(	33	)	,								
	 County	 Varchar2 	(	9	)	,								
	 Gender	 Varchar2 	(	6	)	,								
	 Date_Of_Birth	 Date 				,								
	...
	Constraint	Solicitor_County_Ck				Check(County in('Galway','Dublin','Donegal','Louth','Tipperary','Westmeath','Meath','Mayo')),								
	Constraint	Solicitor_Gender_Ck				Check(Gender in('Male','Female')),								
	Constraint	Solicitor_Mobile_No_Uq				Unique(Mobile_No),								
	Constraint	Solicitor_Email_Address_Uq				Unique(Email_Address),								
	Constraint	Solicitor_Qualifications_Ck				Check(Qualifications in ('B.A. (Hons) Law','M.A. Law')),								
	Constraint	Solicitor_Specialism_Ck				Check(Specialism in ('Property','Crime','Family Law')));								
...
create table 	Auctioneer 	(												
	Auctioneer_Id	 Number	(	4	)	,								
	 Fname	 Varchar2 	(	8	)	Constraint Auctioneer_Fname_NN Not Null,								
	 Sname	 Varchar2 	(	8	)	Constraint Auctioneer_Sname_NN Not Null,								
	 Address	 Varchar2 	(	44	)	,								
	 County	 Varchar2 	(	9	)	,								
	 Gender	 Varchar2 	(	6	)	,								
	 Birth_Date	 Date 				,								
	...
	Constraint	Auctioneer_Auctioneer_Id_Pk				Primary Key(Auctioneer_Id),								
	Constraint	Auctioneer_County_Ck				Check(County in('Roscommon','Meath','Dublin','Clare','Donegal','Cork')),								
	Constraint	Auctioneer_Gender_Ck				Check(Gender in('Male','Female')),								
	Constraint	Auctioneer_Mobile_No_Uq				Unique(Mobile_No),								
	Constraint	Auctioneer_Email_Uq				Unique(Email),								
	Constraint	Auctioneer_Qualifications_Ck				Check(Qualifications in ('M.I.P.A.V.','F.I.P.A.V. Commissioner for Oaths ')),								
	Constraint	Auctioneer_Specialism_Ck				Check(Specialism in ('Land','Commercial Property','Retail Units','Housing')),								
	Constraint	Auctioneer_Annual_Turnover_Ck				Check(Annual_Turnover between 75000 and 150000));								
...
create table 	Rental_Contract 	(												
	Farm_Id	 Number	(	4	)	,								
	 ...
	 Solicitor_Id	 Number	(	4	)	,								
	 Auctioneer_Id	 Number	(	4	)	,								
	Constraint	Rental_Contract_F_F_C_Id_Pk				Primary Key(Farmer_Id,Farm_Id,Contract_Date),								
	Constraint	Rental_Contract_Duration_Ck				Check(Duration between 6 and 18),								
	Constraint	Rental_Contract_Pay_Terms_Ck				Check(Payment_Terms in('Full Amount In Advance','Monthly Instalments', 'Quarterly Instalments','Monthly Instalments')),								
	Constraint	Rental_Contract_Solicit_Id_Fk				Foreign Key(Solicitor_Id)References  Solicitor(Solicitor_Id),								
	Constraint	Rental_Contract_Auction_Id_Fk				Foreign Key(Auctioneer_Id)References  Auctioneer(Auctioneer_Id),								
	Constraint	Rental_Contract_Farmer_Id_Fk				Foreign Key(Farmer_Id)References  Farmer(Farmer_Id),								
	Constraint	Rental_Contract_Farm_Id_Fk				Foreign Key(Farm_Id)References  Farm(Farm_Id));								
